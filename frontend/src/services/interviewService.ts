...
export const interviewService = {
  ...
  async inviteInterview(data: { missionId: string; freelancerId: string; scheduledAt: string; duration: number; meetingLink?: string; notes?: string; coverLetter?: string; proposedRate?: number }) {
    return post<Interview>('/interviews/invite', data);
  }
};