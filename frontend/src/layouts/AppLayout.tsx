...
const AppLayout = () => {
  ...
  { icon: Users, label: 'Find Talent', path: '/matching/find' },
  { icon: Star, label: 'Shortlist', path: '/matching/shortlist' },
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Sidebar */}
  <div className={`${sidebarOpen ? 'w-64' : 'w-16'} transition-all duration-300 bg-sidebar border-r border-sidebar-border relative`}>
        <div className="p-4">
